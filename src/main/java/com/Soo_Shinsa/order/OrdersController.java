...
public class OrdersController {
    ...
    //특정유저의 모든 오더 읽기
    @GetMapping("/users")
    public ResponseEntity<Page<OrdersResponseDto>> getOrderByAll(@AuthenticationPrincipal UserDetails userDetails,
    ...
    //    단품 구매 생성
    @PostMapping("/single")
    public ResponseEntity<OrdersResponseDto> createSingleProductOrder(@AuthenticationPrincipal UserDetails userDetails,
    ...
    //카트에 담음 물건을 구매 생성
    @PostMapping("/carts")
    public ResponseEntity<OrdersResponseDto> createOrderFromCart(@AuthenticationPrincipal UserDetails userDetails) {
        User user = UserUtils.getUser(userDetails);
    ...
    //오더 단일 생성
    @PostMapping()
    public ResponseEntity<OrdersResponseDto> createOrder(@AuthenticationPrincipal UserDetails userDetails) {
        User user = UserUtils.getUser(userDetails);
    ...
    //오더 수정
    @PatchMapping()
    public ResponseEntity<OrdersResponseDto> updateOrder(@AuthenticationPrincipal UserDetails userDetails,
